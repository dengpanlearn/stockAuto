...
enum STOCK_CALC_EVENT_CMD
{
	...
	STOCK_QT_EVENT_QUERY_STOCK_REALKLINE_PREVKLINE,
	...
	STOCK_CALC_EVENT_INSERT_TRACE_RECORD,
	STOCK_CALC_EVENT_INSERT_TRACE_RECORD_RESP,
	STOCK_QT_EVENT_QUERY_TRACE_RECORD
};
...
enum STOCK_CALC_TRACE_STEP
{
	...
	CALC_STOCK_TRADE_STEP_WAIT_BUYING,
	CALC_STOCK_TRADE_STEP_WAIT_SELLING
};
...
typedef STOCK_CALC_UPDATE_TRACELOG STOCK_CALC_INSERT_TRACERECORD;
typedef STOCK_CALC_UPDATE_TRACELOG_RESP STOCK_CALC_INSERT_TRACERECORD_RESP;
...
struct STOCK_TRACE_JOB_TRACERECORD_INSERT
{
	UINT	jobStep;
};
