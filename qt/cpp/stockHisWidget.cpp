...
void CStockHisWidget::OnInit()
{
	...
	char const* header[] = {
		...
		STOCK_HIS_WIDGET_TREE_HISKLINE_NAME_RSI,STOCK_HIS_WIDGET_TREE_HISKLINE_NAME_PERCENT,STOCK_HIS_WIDGET_TREE_HISKLINE_NAME_VOL
	};
...
void CStockHisWidget::ShowHisKLineItem(QTreeWidgetItem* pItem, STOCK_CALC_TRACE_KLINE* pKLine)
{
	...
	QString volVal = QString::number(((double)pKLine->volume)/100, 'f', 2);
	pItem->setText(STOCK_HIS_WIDGET_TREE_HISKLINE_INDEX_VOL, volVal);
}
