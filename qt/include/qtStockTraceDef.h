...
enum
{
	QT_STOCK_TRACE_LOG_STAT_HIGH_REACHED = 0x01,
	QT_STOCK_TRACE_LOG_STAT_RAISE_BALANCED,
	QT_STOCK_TRACE_LOG_STAT_VOLUME_REACHED,
...
#define QT_STOCK_REALKLINE_INFO_HISKLINES	3
struct QT_STOCK_REALKLINE_INFO
{
	...
	int		hisCounts;
	STOCK_CALC_TRACE_KLINE prevKLine[QT_STOCK_REALKLINE_INFO_HISKLINES];
};
